...
export const MobileMenuButton = ({openMobileMenu, setOpenMobileMenu}: {
    ...
    return (
        <button onClick={() => setOpenMobileMenu(!openMobileMenu)}
                className={"relative z-10 flex flex-col md:hidden w-12 sm:w-20 justify-evenly pl-2 sm:pl-10 h-16 my-3"}>
            <div
                className={clsx("relative top-0 w-full border-[1px] border-white transition-all duration-500", {"rotate-[135deg] top-2.5": openMobileMenu})}></div>
            <div
