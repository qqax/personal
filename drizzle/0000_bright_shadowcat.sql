...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "concert_records" ADD CONSTRAINT "concert_records_concert_id_concerts_id_fk" FOREIGN KEY ("concert_id") REFERENCES "public"."concerts"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
